...
async def test_requirements_unit(db, api):
    ...
    category_2["unit"] = {"code": "P1", "name": "відсоток"}
    ...
    profile_2["unit"] = {"code": "P1", "name": "відсоток"}
