...
async def test_migrate_iso_requirements(db, api):
    ...
    category_another_req["criteria"][0]["requirementGroups"][0]["requirements"] = [
        ...
        },
        {
            "title": "Категорія",
            "dataType": "string",
            "expectedValues": ["Відбірні (XL)", "Вища (L)", "Перша (М)", "Друга (S)"],
            "expectedMinItems": 1,
            "expectedMaxItems": 1,
    ...
    product_1["requirementResponses"] = [{"requirement": "Відповідність ДСТУ 5028", "values": ["Так"]}]
    ...
    product_2["requirementResponses"] = [{"requirement": "Відповідність ДСТУ 5028", "values": ["Hi"]}]
    ...
    product_3["requirementResponses"] = [
        {"requirement": "Відповідність ГОСТ 5028", "values": [False]},
        {
    ...
    product_4["requirementResponses"] = [{"requirement": "Відповідність ДСТУ 5028", "values": [False]}]
