...
> [!WARNING]
> **DEPRECATED — Бан від імені ЦЗО**
>
> Механізм бану, прив'язаний до конкретної організації ЦЗО (`administrator.identifier.id`)
> і обмежений її зоною відповідальності по категоріях, більше не підтримується.
>
> Починаючи з **Локалізації v3.0**, бан накладається від імені адміністратора Прозорро
> і блокує весь запис контрибутора (всі категорії, всі заявки).
> Деталі: [`docs/vendor_to_crowdsourcing/plan.md`](../vendor_to_crowdsourcing/plan.md)
