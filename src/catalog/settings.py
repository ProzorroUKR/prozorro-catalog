...
LOCALIZATION_CRITERIA = "CRITERION.OTHER.SUBJECT_OF_PROCUREMENT.LOCAL_ORIGIN_LEVEL"
TECHNICAL_FEATURES_CRITERIA = "CRITERION.OTHER.SUBJECT_OF_PROCUREMENT.TECHNICAL_FEATURES"

CRITERIA_LIST = (
    LOCALIZATION_CRITERIA,
    TECHNICAL_FEATURES_CRITERIA,
)
