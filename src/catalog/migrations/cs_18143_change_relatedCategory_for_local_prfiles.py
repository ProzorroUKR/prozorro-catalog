...
PROFILE_MAPPING = {
    ...
    "Великовантажні мототранспортні засоби (від автокранів, сміттєвозів до єлектробусів)": {
        ...
        "profiles": [
            ...
            "999947-99999999-919998-02426097" "999948-99999999-919998-02426097",
    ...
    "Військові літаки (навчально-тренувальні літаки та пошуково-рятувальні вертольоти)": {
        "class_id": "35610000-3",
        "profiles": ["999983-99999999-919998-02426097", "999984-99999999-919998-02426097"],
    },
    ...
    "Машини для земляних робіт": {"class_id": "43210000-8", "profiles": ["999184-99999999-919998-02426097"]},
    "Фронтальні ковшові навантажувачі": {"class_id": "43250000-0", "profiles": ["999183-99999999-919998-02426097"]},
    ...
    "Машини для обробки мінералів": {"class_id": "43410000-0", "profiles": ["999177-99999999-919998-02426097"]},
}
...
PRODUCTS_CLASSIFICATION_MAPPING = {
    "34200000-9": {
        ...
        "classification": {"id": "34210000-2", "description": "Кузови транспортних засобів", "schema": "ДК021"},
    },
    "34600000-3": {
        "title": "Залізничні локомотиви та тендери",
        "classification": {"id": "34610000-6", "description": "Залізничні локомотиви та тендери", "schema": "ДК021"},
    },
    "43000000-3": {
    ...
    "43200000-5": {
        ...
        "classification": {"id": "43210000-8", "description": "Машини для земляних робіт", "schema": "ДК021"},
    },
}
    ...
    for prev_class_id, new_product_data in PRODUCTS_CLASSIFICATION_MAPPING.items():
        async for product in products_collection.find(
            ...
            category = await category_collection.find_one(
                filter={
                    "classification.id": new_product_data["classification"]["id"],
            ...
            bulk.append(UpdateOne(filter={"_id": product["_id"]}, update={"$set": updated_data}))
            counter += 1
