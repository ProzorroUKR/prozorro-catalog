...
CATEGORY_MAPPING = {
    ...
    "31710000-6": "Електронне обладнання (конденсатори постійної, змінної та регульованої ємності)",
    "34114122-0": "Транспортні засоби для перевезення пацієнтів",
    "34121000-1": "Міські та туристичні автобуси (двосекційні та низькопідлогові)",
    ...
    "34731100-1": "Двигуни для повітряних літальних апаратів (турбореактивні, реактивні та турбовані)",
