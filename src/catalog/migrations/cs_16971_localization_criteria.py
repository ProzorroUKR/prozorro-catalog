...
NEW_CRITERIA_DATA = [
    {
        ...
        "description": "Товар включений до додаткового переліку, що затверджений Кабінетом Міністрів України, "
                       "і має ступінь локалізації виробництва, який перевищує або дорівнює ступеню локалізації"
                       " виробництва, встановленому на відповідний рік. Ці вимоги не застосовуються до закупівель, "
                       "які підпадають під дію положень Закону України \"Про приєднання України до "
                       "Угоди про державні закупівлі\", а також положень про державні закупівлі інших міжнародних "
                       "договорів України, згода на обов’язковість яких надана Верховною Радою України.",
        "classification": {
          "scheme": "ESPD211",
          "id": "OTHER.SUBJECT_OF_PROCUREMENT.LOCAL_ORIGIN_LEVEL"
        },
        "legislation": [
            {
                "version": "2021-12-16",
            ...
            },
            {
                ...
                "identifier": {
                  ...
                  "id": "861-2022-п",
                  "legalName": "Про затвердження порядків підтвердження ступеня "
                               "локалізації виробництва товарів та проведення моніторингу "
                               "дотримання вимог щодо ступеня локалізації виробництва предметів закупівлі, "
        ...
        "requirementGroups": [
                ...
                "requirements": [
                    {
                        "title": "Ступінь локалізації виробництва товару, "
                                 "що є предметом закупівлі, перевищує або дорівнює "
                                 "ступеню локалізації виробництва, встановленому на відповідний рік",
                        "dataType": "number",
                        "minValue": 20,
                        "unit": {
                            "name": "Відсоток",
            ...
            },
            {
                ...
                "requirements": [
                    {
                        "title": "Товар походить з однієї з країн, що підписала Угоду "
                                 "про державні закупівлі Світової Організації торгівлі (GPA) "
                                 "або іншої країни з якою Україна має міжнародні договори про державні закупівлі",
                        "dataType": "string",
                        "expectedValues": [
                              "AT",
                              "BE",
                        ...
                        "eligibleEvidences": [{
                            "title": "Документ, що підтверджує країну походження предмету закупівлі",
